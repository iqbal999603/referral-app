...
# ========== LOADING SCREEN PLACEHOLDER (WELCOME MESSAGE) ==========
# یہ پلیس ہولڈر سب سے پہلے خوبصورت پیغام دکھائے گا، پھر غائب ہو جائے گا
loading_placeholder = st.empty()

# خوبصورت HTML/CSS لوڈنگ صفحہ (آپ کی فرمائش کے مطابق)
welcome_html = """
<!DOCTYPE html>
<html>
<head>
    ...
    <style>
        * {
        ...
        body {
            ...
            font-family: 'Segoe UI', 'Tahoma', 'Urdu Typesetting', 'Noto Naskh Arabic', Arial, sans-serif;
            display: flex;
...
<body>
    <div class="card">
        <h1>✨ خوش آمدید ✨</h1>
        <div class="shukriya">
            🤲 ہم آپ کا بے حد شکریہ ادا کرتے ہیں<br>
            کہ آپ نے ہماری ویب سائٹ پر تشریف لائے۔
        </div>
        <div class="loader"></div>
        <p style="font-size:1rem;">⏳ براہِ کرم تھوڑا سا انتظار کیجیے ⏳</p>
        <p style="font-size:0.95rem; margin-top:12px;">ویب سائٹ لوڈ ہو رہی ہے۔ آپ کی مہربانی ہوگی۔</p>
        <p style="font-size:0.95rem; margin-top:12px; font-style:italic;">🌸 بہت بہت شکریہ — جلد ہم آپ کی خدمت میں حاضر ہیں 🌸</p>
        <div class="footer-note">🕊️ تھوڑا صبر... خوبصورت تجربہ آنے والا ہے</div>
    </div>
</body>
</html>
"""

# پلیس ہولڈر میں HTML دکھائیں (یہ فوراً نظر آئے گا)
loading_placeholder.markdown(welcome_html, unsafe_allow_html=True)
...
<style>
    ...
    .stAlert {
        background-color: #lelele !important;
        color: white !important;
    }
...
# Initialize database (یہاں ڈیٹا بیس بنتا/چیک ہوتا ہے)
init_db()

# اب جب ڈیٹا بیس اور تمام ابتدائیہ کام مکمل ہو چکا ہے، تو لوڈنگ اسکرین ہٹا دیں
...
<style>
    ...
    .main .block-container {
        padding-bottom: 50px;import streamlit as st
import sqlite3
import hashlib
import random
import string
