...
# Header
st.markdown('<div class="main-header"><h1>📱 Ali Mobiles Repairing</h1><p><h1>Ali Laal Road Layyah  03006762827</h1></p><p><h2>ریفرل کرو، موبائل ریپئرنگ ڈسکاؤنٹ پاؤ<h2></p></div>', unsafe_allow_html=True)
