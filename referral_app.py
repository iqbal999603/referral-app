...
# Header
st.markdown('<div class="main-header"><h1>📱 Ali Mobiles Repairing Ali Laal Road Layyah 03006762827</h1><p>ریفرل کرو، ڈسکاؤنٹ پاؤ — صرف اسی دن شاپ بند ہونے سے پہلے پہلے</p></div>', unsafe_allow_html=True)
