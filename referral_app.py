...
if st.session_state.page == "Home":
    if not st.session_state.logged_in:
        st.markdown('<div class="gradient-card"><h2>✨ Welcome to Ali Mobile Repair"ALIOFFICIAL"</h2><p>Join our referral program and earn discounts on mobile repairs!<h2>✨Refrrer Code"ALIOFFICIAL"</h2></p></div>', unsafe_allow_html=True)
    ...
    with st.form("reg_form", clear_on_submit=False):
        ...
        st.info("📢 Referral Code is MANDATORY. Please enter a valid code from any existing user or this>>> <p><h4>ALIOFFICIAL</h4></p>")
