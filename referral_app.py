...
# Header
st.markdown('<div class="main-header"><h1>📱 Ali Mobiles Repairing</h1><p>Ali Laal Road Layyah | 03006762827</p><p><h1>ریفرل کرو، موبائل ریپئرنگ ڈسکاؤنٹ پاؤ<h1></p></div>', unsafe_allow_html=True)
